...
public class HdrProcessingTests
{
    ...
    public void ProcessHdrSeries_WithTransparentHdrSettings_MatchesReferenceBytes()
    {
        var expectedHashes = new Dictionary<string, string>
        {
            ["CPU"] = "CAED73BC396676C309BCAF9B3766402486D526EBE685BE1C611B21A75C6BAC39",
            ["SIMD"] = "622BA869EFF481E6F1317B893206C0FFFAB285A0930EEFF9576FF6EFBBA2DD8C",
            ["GPU"] = "0A3D2FB4F501C926C701F64E3AEC5AFB3D5B3D60442B5268246DA43C99F25EBB"
        };
